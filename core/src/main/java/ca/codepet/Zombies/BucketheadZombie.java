...
public class BucketheadZombie extends Zombie {
    ...
    public BucketheadZombie(DayWorld theWorld) {
        ...
        TextureAtlas walkAtlas2 = new TextureAtlas(Gdx.files.internal("zombies/bucketheadZombie/buckethead-idle-2.atlas"));
        ...
        TextureAtlas walkAtlas3 = new TextureAtlas(Gdx.files.internal("zombies/bucketheadZombie/buckethead-idle-3.atlas"));
        ...
        TextureAtlas attackAtlas3 = new TextureAtlas(Gdx.files.internal("zombies/bucketheadZombie/buckethead-attack-3.atlas"));
